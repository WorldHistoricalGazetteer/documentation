...
| VM embedding generation too slow | Low | Medium | Pre-load model; batch small contributions; optimise ONNX runtime |
...
| Compute node unavailable for batch embedding | Medium | Medium | Queue jobs; VM fallback for small batches; schedule during low-usage |
